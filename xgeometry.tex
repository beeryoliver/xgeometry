...
\begin{code}{\xgeometrysetup}
  \begin{syntax}
    \cs{xgeometrysetup} \marg{key-value list}
  \end{syntax}
  Sets and processes the \pkg{xgeometry} package keys (\S\ref{sec:keys}) in
  \meta{key-value list}.
  % All assignments made by \cs{xgeometrysetup} are local to the current group.
...
\begin{code}{body/include-header}
  ...
  \end{syntax}
  Boolean key that sets whether the header is included as part of the body.
  The initial value is |false|.
\end{code}
...
\begin{code}{body/include-footer}
  ...
  \end{syntax}
  Boolean key that sets whether the footer is included as part of the body.
  The initial value is |false|.
\end{code}
...
\begin{code}{body/include-margin-notes}
  ...
  \end{syntax}
  Boolean key that sets whether the margin notes are included as part of the
  body.
  The initial value is |false|.
\end{code}
